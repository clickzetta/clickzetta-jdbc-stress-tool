...
if [ ! -f clickzetta-java-1.1.1-jar-with-dependencies.jar ]
then
  wget https://autolake-dev-beijing.oss-cn-beijing.aliyuncs.com/clickzetta-tool/release/clickzetta-java-1.1.1-jar-with-dependencies.jar
fi
